...
const stations: Station[] = [
  ...
  },
  {
    ...
    startTime: 1,
    endTime: 2,
    title: 'Mapeamos soluciones con técnicas OSINT',
  ...
  },
  {
    ...
    startTime: 3,
    endTime: 4,
    title: 'Construimos flujos agénticos',
    description: 'Layering Context o RAG, diseñamos sistemas que aprenden, responden y convierten. Integración completa con CRM y email automation.',
