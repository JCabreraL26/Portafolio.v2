...
const stations: Station[] = [
  ...
  },
  {
    ...
    startTime: 1,
    endTime: 2,
    title: 'Mapear el terreno',
    description: 'Ingeniería inversa de sistemas legacy y análisis de datos con Power BI + Python. Documentamos flujos críticos sin acceso a código fuente y transformamos información en decisiones.',
    ctaText: 'Ver iDomo',
  ...
  },
  {
    ...
    startTime: 2,
    endTime: 3,
    title: 'Sistemas escalables impulsados por IA',
    description: 'Arquitectura adaptable a etapa de negocio: serverless para validar rápido, contenedores para escalar con control. Decisión técnica basada en datos, no en hype.',
  ...
  },
  {
    ...
    endTime: 4,
    title: 'Agentic AI',
    description: 'Construimos agentes IA que aprenden, responden y convierten. RAG para precisión absoluta, o Context Layering para respuestas rápidas y económicas. Decisión técnica basada en KPIs específicos.',
  ...
  },
  {
    ...
    startTime: 4,
    endTime: 5,
    title: 'Conversión y tracción real',
